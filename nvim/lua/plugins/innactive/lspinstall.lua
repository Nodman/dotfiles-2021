-- this is my initial config for builtin lspconfig, but for now I decided to stick with CoC
local on_attach = function (client, bufnr)
  ...
  if client.resolved_capabilities.document_range_formatting then
    buf_set_keymap("v", "<tab>", "<cmd>lua vim.lsp.buf.range_formatting()<CR>", opts)
  end
...
local function setup_servers()
  ...
  for _, server in pairs(servers) do
    ...
    if server == "lua" then
      config.settings = require'lsp-configs/sumneko-lua'.settings
