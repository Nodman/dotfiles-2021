...
map('n', '<leader>fS', '<CMD>lua require"plugins.telescope".live_grep_in_folder()<CR>', {silent = true})
...
map('n', '<leader>fr', builtinTemplate..'resume()<CR>', {silent = true})
map('n', '<leader>fw', builtinTemplate..'grep_string { search = vim.fn.expand("<cword>"), only_sort_text = true }<CR>', {silent = true})
