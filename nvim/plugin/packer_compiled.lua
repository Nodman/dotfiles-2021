...
pcall(vim.cmd, [[command -nargs=* -range -bang -complete=file DapEnable lua require("packer.load")({'nvim-dap'}, { cmd = "DapEnable", l1 = <line1>, l2 = <line2>, bang = <q-bang>, args = <q-args> }, _G.packer_plugins)]])
